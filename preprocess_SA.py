...
"""
Example usage:
python preprocess_SA.py -f /Users/arun/Desktop/JHU/sapling/NN/marcc/chr22/sa_chr22.key.row -d ./preprocessed/chr22/
python preprocess_SA.py -f /Users/arun/Desktop/JHU/sapling/rust/sa_ecoli.key.row -d ./preprocessed/ecoli/
"""

"""
Arguments:
-f: Path to the folder containing the suffix array file (.key.row)
-d: Path to the folder where the numpy arrays should be saved
-v: Verbose flag
"""
